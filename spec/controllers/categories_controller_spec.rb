...
#   let(:valid_attributes) { { "name" => "awesome" } }
...
#         Category.any_instance.should_receive(:update).with({ "name" => "super" })
#         put :update, {:id => category.to_param, :category => { "name" => "super" }}, valid_session
#       end
